...
const ENTRY_POINTS = fs
    .readdirSync(`${basePath}/_includes/templates`)
...
const multipleHtmlPlugins = ENTRY_POINTS.map((name) => {
    return new HtmlWebpackPlugin({
        ...
        hash: true,
        templateParameters: {
            analytics: name !== "main", // For now, disable analytics for starter project landing page
            prismjs: name == "main", // Syntax highlighting only on landing page.
        },
    });
});
